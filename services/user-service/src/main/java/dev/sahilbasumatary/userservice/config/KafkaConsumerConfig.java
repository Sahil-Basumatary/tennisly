package dev.sahilbasumatary.userservice.config;
    ...
    public ConsumerFactory<String, BaseEvent> consumerFactory() {
        ...
        props.put(JsonDeserializer.TYPE_MAPPINGS,
                "userEvent:dev.sahilbasumatary.common.event.UserEvent,"
                        + "orgEvent:dev.sahilbasumatary.common.event.OrganizationEvent");
    ...
    public CommonErrorHandler kafkaErrorHandler() {
        DeadLetterPublishingRecoverer recoverer =
                new DeadLetterPublishingRecoverer(dlqKafkaTemplate(),
                        (record, ex) -> {
                            log.error("Sending failed record to DLQ: topic={} key={} error={}",
